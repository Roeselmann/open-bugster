...
export const operations: ReadonlyMap<string, AnyOperation> = new Map(
  [...Object.values(accounts), ...Object.values(attachments), ...Object.values(boardDomain), ...Object.values(credentials), ...Object.values(tickets), ...Object.values(ticketTypes), ...Object.values(webhooks), ...Object.values(workspaces)]
    .filter(isOperation)
